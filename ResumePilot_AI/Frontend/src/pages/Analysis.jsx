    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex relative overflow-hidden">
      ...
      <main className="flex-1 ml-72 p-10 z-10 h-screen overflow-y-auto">
        ...
        >
          ...
          <h3 className="text-2xl font-bold text-slate-400">Detailed Analysis</h3>
          <p className="text-slate-500 mt-2 max-w-xl mx-auto">
            Deep dive into your resume's semantic matches, sentence structure, and grammatical suggestions. This feature is currently under development.
          </p>
        </motion.div>
      </main>
    </div>
